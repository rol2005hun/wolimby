<template>
  <main class="index">
    <h1><i class="fa-solid fa-circle-info"></i> a little information</h1>
    <br>
    <h3>using the navbar, you can can navigate to other pages, like about</h3>
    <div class="music-player">
      ...
      <div class="music-player-track">
        ...
        <div class="music-player-track-info">
          ...
          <input type="range" class="slider-music" title="Húzogassad kedved szerint" :value="msuicSlider" @input="e => setTime(parseFloat((e.target as HTMLInputElement).value))">
        </div>
...
import playlist from '@/assets/js/musiclist.json';
...
onMounted(() => {
  ...
  audioElement.value?.addEventListener('timeupdate', () => {
    ...
    msuicSlider.value = (currentTime.value / duration.value) * 100 || 0;
  });
});
</script>